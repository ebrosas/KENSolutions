...
ALTER TABLE [kenuser].[RecruitmentRequest] ADD DEFAULT '2026-02-25T15:55:01.228' FOR [CreatedDate];
GO
...
ALTER TABLE [kenuser].[RecruitmentBudget] ADD DEFAULT '2026-02-25T15:55:01.227' FOR [CreatedDate];
GO
...
ALTER TABLE [kenuser].[PayrollPeriod] ADD DEFAULT '2026-02-25T15:55:01.234' FOR [CreatedDate];
GO
...
ALTER TABLE [kenuser].[MasterShiftPatternTitle] ADD DEFAULT '2026-02-25T15:55:01.230' FOR [CreatedDate];
GO
...
ALTER TABLE [kenuser].[LeaveRequisitionWF] ADD DEFAULT '2026-02-25T15:55:01.233' FOR [LeaveCreatedDate];
GO
...
ALTER TABLE [kenuser].[LeaveEntitlement] ADD DEFAULT '2026-02-25T15:55:01.234' FOR [CreatedDate];
GO
...
ALTER TABLE [kenuser].[Holiday] ADD DEFAULT '2026-02-25T15:55:01.232' FOR [CreatedDate];
GO

ALTER TABLE [kenuser].[Employee] ADD [SecurityAnswer1] varchar(50) NULL;
GO

ALTER TABLE [kenuser].[Employee] ADD [SecurityAnswer2] varchar(50) NULL;
GO

ALTER TABLE [kenuser].[Employee] ADD [SecurityAnswer3] varchar(50) NULL;
GO

ALTER TABLE [kenuser].[Employee] ADD [SecurityQuestion1] varchar(150) NULL;
GO

ALTER TABLE [kenuser].[Employee] ADD [SecurityQuestion2] varchar(150) NULL;
GO

ALTER TABLE [kenuser].[Employee] ADD [SecurityQuestion3] varchar(150) NULL;
GO
...
ALTER TABLE [kenuser].[DepartmentMaster] ADD DEFAULT '2026-02-25T12:55:01.227' FOR [CreatedAt];
GO
...
ALTER TABLE [kenuser].[AttendanceTimesheet] ADD DEFAULT '2026-02-25T15:55:01.233' FOR [CreatedDate];
GO
...
ALTER TABLE [kenuser].[AttendanceSwipeLog] ADD DEFAULT '2026-02-25T15:55:01.233' FOR [SwipeLogDate];
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260225125502_AddUserRegistrationFields', N'8.0.17');
GO

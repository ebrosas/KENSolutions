...
ALTER TABLE [kenuser].[RecruitmentRequest] ADD DEFAULT '2026-02-19T15:39:52.280' FOR [CreatedDate];
GO
...
ALTER TABLE [kenuser].[RecruitmentBudget] ADD DEFAULT '2026-02-19T15:39:52.277' FOR [CreatedDate];
GO
...
ALTER TABLE [kenuser].[PayrollPeriod] ADD DEFAULT '2026-02-19T15:39:52.297' FOR [CreatedDate];
GO
...
ALTER TABLE [kenuser].[MasterShiftPatternTitle] ADD DEFAULT '2026-02-19T15:39:52.285' FOR [CreatedDate];
GO
...
ALTER TABLE [kenuser].[LeaveRequisitionWF] ADD DEFAULT '2026-02-19T15:39:52.295' FOR [LeaveCreatedDate];
GO
...
ALTER TABLE [kenuser].[LeaveEntitlement] ADD DEFAULT '2026-02-19T15:39:52.296' FOR [CreatedDate];
GO
...
ALTER TABLE [kenuser].[Holiday] ADD DEFAULT '2026-02-19T15:39:52.292' FOR [CreatedDate];
GO

ALTER TABLE [kenuser].[Employee] ADD [FailedLoginAttempts] int NOT NULL DEFAULT 0;
GO

ALTER TABLE [kenuser].[Employee] ADD [IsLocked] bit NOT NULL DEFAULT CAST(0 AS bit);
GO

ALTER TABLE [kenuser].[Employee] ADD [PasswordHash] varchar(200) NULL;
GO

ALTER TABLE [kenuser].[Employee] ADD [UserID] varchar(40) NULL;
GO
...
ALTER TABLE [kenuser].[DepartmentMaster] ADD DEFAULT '2026-02-19T12:39:52.277' FOR [CreatedAt];
GO
...
ALTER TABLE [kenuser].[AttendanceTimesheet] ADD DEFAULT '2026-02-19T15:39:52.294' FOR [CreatedDate];
GO
...
ALTER TABLE [kenuser].[AttendanceSwipeLog] ADD DEFAULT '2026-02-19T15:39:52.293' FOR [SwipeLogDate];
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260219123954_AddAuthFieldsToEmployee', N'8.0.17');
GO

...
ALTER TABLE [kenuser].[RecruitmentRequest] ADD DEFAULT '2026-02-27T15:26:28.253' FOR [CreatedDate];
GO
...
ALTER TABLE [kenuser].[RecruitmentBudget] ADD DEFAULT '2026-02-27T15:26:28.251' FOR [CreatedDate];
GO
...
ALTER TABLE [kenuser].[PayrollPeriod] ADD DEFAULT '2026-02-27T15:26:28.262' FOR [CreatedDate];
GO
...
ALTER TABLE [kenuser].[MasterShiftPatternTitle] ADD DEFAULT '2026-02-27T15:26:28.256' FOR [CreatedDate];
GO
...
ALTER TABLE [kenuser].[LeaveRequisitionWF] ADD DEFAULT '2026-02-27T15:26:28.261' FOR [LeaveCreatedDate];
GO
...
ALTER TABLE [kenuser].[LeaveEntitlement] ADD DEFAULT '2026-02-27T15:26:28.262' FOR [CreatedDate];
GO
...
ALTER TABLE [kenuser].[Holiday] ADD DEFAULT '2026-02-27T15:26:28.260' FOR [CreatedDate];
GO

ALTER TABLE [kenuser].[Employee] ADD [EmailVerificationToken] varchar(500) NULL;
GO

ALTER TABLE [kenuser].[Employee] ADD [EmailVerificationTokenExpiry] datetime NULL;
GO

ALTER TABLE [kenuser].[Employee] ADD [IsEmailVerified] bit NOT NULL DEFAULT CAST(0 AS bit);
GO
...
ALTER TABLE [kenuser].[DepartmentMaster] ADD DEFAULT '2026-02-27T12:26:28.251' FOR [CreatedAt];
GO
...
ALTER TABLE [kenuser].[AttendanceTimesheet] ADD DEFAULT '2026-02-27T15:26:28.261' FOR [CreatedDate];
GO
...
ALTER TABLE [kenuser].[AttendanceSwipeLog] ADD DEFAULT '2026-02-27T15:26:28.260' FOR [SwipeLogDate];
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260227122630_AddAuthenticationTokenFields', N'8.0.17');
GO

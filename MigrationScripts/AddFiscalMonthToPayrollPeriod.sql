...
DROP INDEX [IX_PayrollPeriod_CompoKeys] ON [kenuser].[PayrollPeriod];
GO
...
ALTER TABLE [kenuser].[RecruitmentRequest] ADD DEFAULT '2026-02-12T14:22:07.483' FOR [CreatedDate];
GO
...
ALTER TABLE [kenuser].[RecruitmentBudget] ADD DEFAULT '2026-02-12T14:22:07.481' FOR [CreatedDate];
GO
...
ALTER TABLE [kenuser].[PayrollPeriod] ADD DEFAULT '2026-02-12T14:22:07.495' FOR [CreatedDate];
GO

ALTER TABLE [kenuser].[PayrollPeriod] ADD [FiscalMonth] int NOT NULL DEFAULT 0;
GO
...
ALTER TABLE [kenuser].[MasterShiftPatternTitle] ADD DEFAULT '2026-02-12T14:22:07.487' FOR [CreatedDate];
GO
...
ALTER TABLE [kenuser].[LeaveRequisitionWF] ADD DEFAULT '2026-02-12T14:22:07.494' FOR [LeaveCreatedDate];
GO
...
ALTER TABLE [kenuser].[LeaveEntitlement] ADD DEFAULT '2026-02-12T14:22:07.495' FOR [CreatedDate];
GO
...
ALTER TABLE [kenuser].[Holiday] ADD DEFAULT '2026-02-12T14:22:07.491' FOR [CreatedDate];
GO
...
ALTER TABLE [kenuser].[DepartmentMaster] ADD DEFAULT '2026-02-12T11:22:07.480' FOR [CreatedAt];
GO
...
ALTER TABLE [kenuser].[AttendanceTimesheet] ADD DEFAULT '2026-02-12T14:22:07.494' FOR [CreatedDate];
GO
...
ALTER TABLE [kenuser].[AttendanceSwipeLog] ADD DEFAULT '2026-02-12T14:22:07.493' FOR [SwipeLogDate];
GO

CREATE UNIQUE INDEX [IX_PayrollPeriod_CompoKeys] ON [kenuser].[PayrollPeriod] ([FiscalYear], [FiscalMonth], [PayrollStartDate], [PayrollEndDate]);
GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260212112209_AddFiscalMonthToPayrollPeriod', N'8.0.17');
GO

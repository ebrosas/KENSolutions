DECLARE	@actionType					TINYINT = 1,		--(Notes: 0 = Check records; 1 = Insert new record)
	...
	*/
	...
	/*	Populate Leave Request Types
	
		SELECT @GroupID = a.UDCGroupId 
		FROM kenuser.UserDefinedCodeGroup a WITH (NOLOCK)
		WHERE RTRIM(a.UDCGCode) = 'LEAVETYPES'

		SELECT	@UDCCode					= 'AL',
				@UDCDesc1					= 'Annual Leave',
				@UDCDesc2					= NULL,
				@UDCSpecialHandlingCode		= NULL,
				@SequenceNo					= 1,
				@IsActive					= 1,
	...
	*/
	...
	/*	Populate Leave Day Portions
	
		SELECT @GroupID = a.UDCGroupId 
		FROM kenuser.UserDefinedCodeGroup a WITH (NOLOCK)
		WHERE RTRIM(a.UDCGCode) = 'LEAVEAPORTION'

		SELECT	@UDCCode					= 'LEAVEFD',
				@UDCDesc1					= 'Full day',
				@UDCDesc2					= NULL,
				@UDCSpecialHandlingCode		= NULL,
				@SequenceNo					= 1,
		...
		SELECT	@UDCCode					= 'LEAVEFH',
				@UDCDesc1					= 'First half of the day',
				@UDCDesc2					= NULL,
				@UDCSpecialHandlingCode		= NULL,
				@SequenceNo					= 2,
				@IsActive					= 1,
		...
		SELECT	@UDCCode					= 'LEAVESH',
				@UDCDesc1					= 'Second half of the day',
				@UDCDesc2					= NULL,
				@UDCSpecialHandlingCode		= NULL,
				@SequenceNo					= 3,
				@IsActive					= 1,
	...
	*/
	...
	/*	Populate Leave Approval Flags
	
		SELECT @GroupID = a.UDCGroupId 
		FROM kenuser.UserDefinedCodeGroup a WITH (NOLOCK)
		WHERE RTRIM(a.UDCGCode) = 'LEAVEAPVFLAG'

		SELECT	@UDCCode					= 'A',
				@UDCDesc1					= 'Approved / Paid',
				@UDCDesc2					= NULL,
				@UDCSpecialHandlingCode		= NULL,
				@SequenceNo					= 1,
				@IsActive					= 1,
	...
	*/
	...
	/*	Populate Workflow Statuses
		...
		SELECT @GroupID = a.UDCGroupId 
		FROM kenuser.UserDefinedCodeGroup a WITH (NOLOCK)
		WHERE RTRIM(a.UDCGCode) = 'WFSTATUS'

		SELECT	@UDCCode					= 'WFRUNNING',
				@UDCDesc1					= 'Running',
				@UDCDesc2					= NULL,
				@UDCSpecialHandlingCode		= NULL,
				@SequenceNo					= 1,
	...
	*/
	...
	/*	Populate Attendance Actions Types
		...
		SELECT @GroupID = a.UDCGroupId 
		FROM kenuser.UserDefinedCodeGroup a WITH (NOLOCK)
		WHERE RTRIM(a.UDCGCode) = 'ATTENDACT'

		SELECT	@UDCCode					= 'REGULARREQ',
				@UDCDesc1					= 'Regularization',
				@UDCDesc2					= NULL,
				@UDCSpecialHandlingCode		= NULL,
				@SequenceNo					= 1,

DECLARE	@actionType					TINYINT = 1,		--(Notes: 0 = Check records; 1 = Insert new record)
	...
	--Add Customer List
	--SELECT	@UDCGCode					= 'CUSTOMERLIST',
	--		@UDCGDesc1					= 'Customer List',
	--		@UDCGDesc2					= NULL,
	--		@UDCGSpecialHandlingCode	= NULL
	...
	--Add Attendance Legends
	--SELECT	@UDCGCode					= 'ATTENDLEGEND',
	--		@UDCGDesc1					= 'Attendance Legends',
	--		@UDCGDesc2					= NULL,
	--		@UDCGSpecialHandlingCode	= NULL
	...
	--SELECT	@UDCGCode					= 'STATUS',
	--		@UDCGDesc1					= 'Service Request Status',
	--		@UDCGDesc2					= NULL,
	--		@UDCGSpecialHandlingCode	= NULL
	...
	--Add Leave Unit of Measure
	--SELECT	@UDCGCode					= 'LEAVEUOM',
	--		@UDCGDesc1					= 'Leave Entitlement Unit of Measure',
	--		@UDCGDesc2					= NULL,
	--		@UDCGSpecialHandlingCode	= NULL

	--Add Request Type
	--SELECT	@UDCGCode					= 'REQTYPE',
	--		@UDCGDesc1					= 'Request Types',
	--		@UDCGDesc2					= NULL,
	--		@UDCGSpecialHandlingCode	= NULL

	--Add Workflow Statuses
	--SELECT	@UDCGCode					= 'WFSTATUS',
	--		@UDCGDesc1					= 'Workflow Status',
	--		@UDCGDesc2					= NULL,
	--		@UDCGSpecialHandlingCode	= NULL

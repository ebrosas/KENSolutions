...
namespace KenHRApp.Application.Common.Validations
{
    ...
    public class GeneralEndDateValidationAttribute : ValidationAttribute
    {
        private readonly string _comparisonProperty;

        public GeneralEndDateValidationAttribute(string comparisonProperty)
        {
        ...
        protected override ValidationResult? IsValid(object? value, ValidationContext validationContext)
        {
            ...
            {
                return new ValidationResult("End Date should be greater than or equals to Start Date.");
            }

...
namespace KenHRApp.Infrastructure.Migrations
{
    ...
    [Migration("20260225125502_AddUserRegistrationFields")]
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.AttendanceSwipeLog", b =>
                {
                    ...
                    b.Property<DateTime?>("SwipeLogDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 25, 15, 55, 1, 233, DateTimeKind.Local).AddTicks(2795));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.AttendanceTimesheet", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 25, 15, 55, 1, 233, DateTimeKind.Local).AddTicks(6758));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.DepartmentMaster", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 25, 12, 55, 1, 227, DateTimeKind.Utc).AddTicks(4801));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.Holiday", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 25, 15, 55, 1, 232, DateTimeKind.Local).AddTicks(8962));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.LeaveEntitlement", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 25, 15, 55, 1, 234, DateTimeKind.Local).AddTicks(1675));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.LeaveRequisitionWF", b =>
                {
                    ...
                    b.Property<DateTime?>("LeaveCreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 25, 15, 55, 1, 233, DateTimeKind.Local).AddTicks(8640));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.MasterShiftPatternTitle", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 25, 15, 55, 1, 230, DateTimeKind.Local).AddTicks(5068));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.PayrollPeriod", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 25, 15, 55, 1, 234, DateTimeKind.Local).AddTicks(4168));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.RecruitmentBudget", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 25, 15, 55, 1, 227, DateTimeKind.Local).AddTicks(7257));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.RecruitmentRequisition", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 25, 15, 55, 1, 228, DateTimeKind.Local).AddTicks(6079));

...
namespace KenHRApp.Infrastructure.Migrations
{
    ...
    [Migration("20260416194935_AddGroupType")]
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.AttendanceSwipeLog", b =>
                {
                    ...
                    b.Property<DateTime?>("SwipeLogDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 4, 16, 22, 49, 33, 222, DateTimeKind.Local).AddTicks(7794));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.AttendanceTimesheet", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 4, 16, 22, 49, 33, 223, DateTimeKind.Local).AddTicks(3018));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.DepartmentMaster", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 4, 16, 19, 49, 33, 212, DateTimeKind.Utc).AddTicks(5186));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.Holiday", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 4, 16, 22, 49, 33, 222, DateTimeKind.Local).AddTicks(3115));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.LeaveEntitlement", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 4, 16, 22, 49, 33, 226, DateTimeKind.Local).AddTicks(4436));
                    ...
                    b.Property<DateTime>("EffectiveDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 4, 16, 22, 49, 33, 226, DateTimeKind.Local).AddTicks(5249))
                        .HasComment("Part of composite unique key index");
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.LeaveRequisitionWF", b =>
                {
                    ...
                    b.Property<DateTime?>("LeaveCreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 4, 16, 22, 49, 33, 224, DateTimeKind.Local).AddTicks(4226));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.MasterShiftPatternTitle", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 4, 16, 22, 49, 33, 218, DateTimeKind.Local).AddTicks(5084));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.PayrollPeriod", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 4, 16, 22, 49, 33, 227, DateTimeKind.Local).AddTicks(9492));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.RecruitmentBudget", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 4, 16, 22, 49, 33, 213, DateTimeKind.Local).AddTicks(724));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.RecruitmentRequisition", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 4, 16, 22, 49, 33, 214, DateTimeKind.Local).AddTicks(8297));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.RequestApproval", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 4, 16, 22, 49, 33, 136, DateTimeKind.Local).AddTicks(3026));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.Workflow.WorkflowApprovalRole", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 4, 16, 22, 49, 33, 152, DateTimeKind.Local).AddTicks(4999));
                    ...
                    b.Property<byte>("GroupType")
                        .HasColumnType("tinyint")
                        .HasComment("0 or NULL = Based on Assigned Employee No; 1 = Based on Employee Master; 2 = Based on Department Master");

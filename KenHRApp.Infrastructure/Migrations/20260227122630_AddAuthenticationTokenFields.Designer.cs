...
namespace KenHRApp.Infrastructure.Migrations
{
    ...
    [Migration("20260227122630_AddAuthenticationTokenFields")]
    partial class AddAuthenticationTokenFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.AttendanceSwipeLog", b =>
                {
                    ...
                    b.Property<DateTime?>("SwipeLogDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 27, 15, 26, 28, 260, DateTimeKind.Local).AddTicks(9771));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.AttendanceTimesheet", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 27, 15, 26, 28, 261, DateTimeKind.Local).AddTicks(4237));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.DepartmentMaster", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 27, 12, 26, 28, 251, DateTimeKind.Utc).AddTicks(5693));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.Holiday", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 27, 15, 26, 28, 260, DateTimeKind.Local).AddTicks(5238));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.LeaveEntitlement", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 27, 15, 26, 28, 262, DateTimeKind.Local).AddTicks(1542));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.LeaveRequisitionWF", b =>
                {
                    ...
                    b.Property<DateTime?>("LeaveCreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 27, 15, 26, 28, 261, DateTimeKind.Local).AddTicks(7202));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.MasterShiftPatternTitle", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 27, 15, 26, 28, 256, DateTimeKind.Local).AddTicks(6989));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.PayrollPeriod", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 27, 15, 26, 28, 262, DateTimeKind.Local).AddTicks(5533));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.RecruitmentBudget", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 27, 15, 26, 28, 251, DateTimeKind.Local).AddTicks(9861));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.RecruitmentRequisition", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 27, 15, 26, 28, 253, DateTimeKind.Local).AddTicks(3902));

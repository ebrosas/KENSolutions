...
namespace KenHRApp.Infrastructure.Migrations
{
    ...
    [Migration("20260212112209_AddFiscalMonthToPayrollPeriod")]
    partial class AddFiscalMonthToPayrollPeriod
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.AttendanceSwipeLog", b =>
                {
                    ...
                    b.Property<DateTime?>("SwipeLogDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 12, 14, 22, 7, 493, DateTimeKind.Local).AddTicks(887));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.AttendanceTimesheet", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 12, 14, 22, 7, 494, DateTimeKind.Local).AddTicks(969));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.DepartmentMaster", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 12, 11, 22, 7, 480, DateTimeKind.Utc).AddTicks(8799));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.Holiday", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 12, 14, 22, 7, 491, DateTimeKind.Local).AddTicks(9172));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.LeaveEntitlement", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 12, 14, 22, 7, 495, DateTimeKind.Local).AddTicks(2868));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.LeaveRequisitionWF", b =>
                {
                    ...
                    b.Property<DateTime?>("LeaveCreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 12, 14, 22, 7, 494, DateTimeKind.Local).AddTicks(5090));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.MasterShiftPatternTitle", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 12, 14, 22, 7, 487, DateTimeKind.Local).AddTicks(7017));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.PayrollPeriod", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 12, 14, 22, 7, 495, DateTimeKind.Local).AddTicks(9125));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.RecruitmentBudget", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 12, 14, 22, 7, 481, DateTimeKind.Local).AddTicks(4767));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.RecruitmentRequisition", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 12, 14, 22, 7, 483, DateTimeKind.Local).AddTicks(3795));

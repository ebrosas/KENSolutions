...
namespace KenHRApp.Infrastructure.Migrations
{
    ...
    [Migration("20260221125507_AddSupportTicket")]
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.AttendanceSwipeLog", b =>
                {
                    ...
                    b.Property<DateTime?>("SwipeLogDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 21, 15, 55, 6, 793, DateTimeKind.Local).AddTicks(6618));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.AttendanceTimesheet", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 21, 15, 55, 6, 793, DateTimeKind.Local).AddTicks(9879));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.DepartmentMaster", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 21, 12, 55, 6, 786, DateTimeKind.Utc).AddTicks(1280));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.Holiday", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 21, 15, 55, 6, 793, DateTimeKind.Local).AddTicks(2999));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.LeaveEntitlement", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 21, 15, 55, 6, 794, DateTimeKind.Local).AddTicks(5149));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.LeaveRequisitionWF", b =>
                {
                    ...
                    b.Property<DateTime?>("LeaveCreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 21, 15, 55, 6, 794, DateTimeKind.Local).AddTicks(2027));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.MasterShiftPatternTitle", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 21, 15, 55, 6, 790, DateTimeKind.Local).AddTicks(8212));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.PayrollPeriod", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 21, 15, 55, 6, 794, DateTimeKind.Local).AddTicks(7848));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.RecruitmentBudget", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 21, 15, 55, 6, 786, DateTimeKind.Local).AddTicks(4491));
            ...
            modelBuilder.Entity("KenHRApp.Domain.Entities.RecruitmentRequisition", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2026, 2, 21, 15, 55, 6, 787, DateTimeKind.Local).AddTicks(4694));

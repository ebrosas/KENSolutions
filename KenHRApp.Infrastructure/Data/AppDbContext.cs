...
namespace KenHRApp.Infrastructure.Data
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<LeaveRequestResult>(entity =>
            {
                entity.HasNoKey();
                entity.ToView(null); // prevents migration
            });

            modelBuilder.Entity<AttendanceCalendarResult>(entity =>
            {
                entity.HasNoKey();
                entity.ToView(null); // prevents migration
            });
            ...
            modelBuilder.Entity<RequestTypeResult>(entity =>
            {
                entity.HasNoKey();
                entity.ToView(null); // prevents migration
            });

            modelBuilder.Entity<WorkflowDetailResult>(entity =>
            {
                entity.HasNoKey();
                entity.ToView(null); // prevents migration
            });
            ...
            modelBuilder.Entity<AttendanceInfoResult>(entity =>
            {
                entity.HasNoKey();
                entity.ToView(null); // prevents migration
            });
            ...
            modelBuilder.Entity<PlannedLeaveResult>(entity =>
            {
                entity.HasNoKey();
                entity.ToView(null); // prevents migration
            });

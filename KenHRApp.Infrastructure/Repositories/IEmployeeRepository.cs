...
namespace KenHRApp.Infrastructure.Repositories
{
    public interface IEmployeeRepository
    {
        ...
        Task<Result<int>> AddQualificationAsync(
            Qualification qualification,
            CancellationToken cancellationToken = default);

        Task<Result<int>> UpdateQualificationAsync(
            Qualification dto,
            CancellationToken cancellationToken = default);
        ...
        Task<Result<int>> AddEmployeeSkillAsync(
            EmployeeSkill skill,
            CancellationToken cancellationToken = default);

        Task<Result<int>> UpdateEmployeeSkillAsync(
            EmployeeSkill dto,
            CancellationToken cancellationToken = default);
        ...
        Task<Result<int>> AddCertificationAsync(
            EmployeeCertification certification,
            CancellationToken cancellationToken = default);

        Task<Result<int>> UpdateCertificationAsync(
            EmployeeCertification dto,
            CancellationToken cancellationToken = default);

        Task<Result<bool>> DeleteCertificationAsync(
            int autoID,
            CancellationToken cancellationToken = default);

        Task<Result<int>> AddLanguageSkillAsync(
            LanguageSkill language,
            CancellationToken cancellationToken = default);

        Task<Result<int>> UpdateLanguageSkillAsync(
            LanguageSkill dto,
            CancellationToken cancellationToken = default);
